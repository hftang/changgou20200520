...
public class BrandController {
    ...
    public Result<List<Brand>> getBrandByCategory(@PathVariable("id") Integer categoryId) {

        List<Brand> brandList = this.brandService.getBrandByCategory(categoryId);

        return new Result< List<Brand>>(true,StatusCode.OK,"品牌全部查询完毕",brandList);
