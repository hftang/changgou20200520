...
public class ParaController {
    ...
    public Result<List<Para>> getParaListByCategoryId(@PathVariable("id") Integer id) {
        List<Para> paraList = this.paraService.getParaListByCategoryId(id);

        return new Result<>(true,StatusCode.OK,"para查询成功",paraList);
    }
