...
public class SpecController {
    ...
    public Result<List<Spec>> getSpecListByCategoryId(@PathVariable("id") Integer categoryId){
        List<Spec> specList=  this.specService.getSpecListByCategoryId(categoryId);
        return new Result<>(true,StatusCode.OK,"查询成功Spec",specList);
    }
