...
public class SpuController {
    ...
    public Result putMany(@RequestBody Long[] ids) {
        ...
        return new Result(true, StatusCode.OK, "批量上架" + count + "个成功");
    ...
    @PutMapping("/audit/{id}")
    public Result auditBySpuId(@PathVariable("id") String id) {
        this.spuService.auditSpuBySpuId(id);
    ...
    @GetMapping("/{id}")
    public Result<Goods> findGoodsById(@PathVariable("id") Integer id) {
        Goods goods = this.spuService.findGoodsBySpuId(id);

        return new Result<>(true, StatusCode.OK, "查询成功goods", goods);
    }
    ...
    public Result addGoods(@RequestBody Goods goods) {
        ...
        this.spuService.addGoods(goods);
     ...
     * @return
     ...
     @PostMapping public Result add(@RequestBody @ApiParam(name = "Spu对象", value = "传入JSON数据", required = true) Spu spu) {
     //调用SpuService实现添加Spu
     spuService.add(spu);
     ...
     * @return
     ...
     @GetMapping public Result<List<Spu>> findAll() {
