...
public class TemplateController {
    ...
    public Result<Template> getTemplateByTemplateId(@PathVariable("id") Integer id) {

        Template templates = this.templateService.getTemplateByTemplateId(id);

        return new Result<Template>(true, StatusCode.OK, "模板查询成功", templates);
