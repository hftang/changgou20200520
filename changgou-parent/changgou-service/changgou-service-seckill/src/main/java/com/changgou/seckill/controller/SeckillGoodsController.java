...
public class SeckillGoodsController {
    ...
    public SeckillGoods one(String time,Long id){
        SeckillGoods seckillGoods = this.seckillGoodsService.seckillGoodsDetail(time, id);
        return seckillGoods;
    }
    ...
    public List<SeckillGoods> list(String time) {
        ...
        List<SeckillGoods> seckillGoodsList = this.seckillGoodsService.getSeckillGoodsByTime(time);
    ...
    public List<Date> dateMenus() {
        ...
        return this.seckillGoodsService.getDateMenus();
    }
