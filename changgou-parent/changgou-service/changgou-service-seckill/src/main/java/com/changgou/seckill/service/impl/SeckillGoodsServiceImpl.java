...
public class SeckillGoodsServiceImpl implements SeckillGoodsService {
     ...
     */
    @Override
    public SeckillGoods seckillGoodsDetail(String time, Long id) {
        SeckillGoods seckillGood = (SeckillGoods) this.redisTemplate.boundHashOps("SeckillGoods_" + time).get(id);
        return seckillGood;
    }

    /***
     * 根据指定的时间段 获取该时间段的秒杀商品 从redis中获取
     * @param time
     * @return
     */
    ...
    public List<SeckillGoods> getSeckillGoodsByTime(String time) {
        ...
        List list = this.redisTemplate.boundHashOps("SeckillGoods_" + time).values();
